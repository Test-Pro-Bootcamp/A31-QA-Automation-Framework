...
public class SongsPage extends BasePage {
    ...
    By allSongTabLocator = By.cssSelector("a.songs");
    By selectFirstSonglocator = By.xpath("//*[@id='songsWrapper']//div[1]/table/tr[1]/td[2]");
    By soundBar = By.xpath("//div[@data-testid='sound-bar-play']");
    By selectFirstSongField = By.xpath("//*[@id='songsWrapper']//div[1]/table/tr[1]/td[2]");
    By addSelectedSong = By.cssSelector("button.btn-add-to");
    By selectCreatedPlaylist = By.xpath("//*[@id='songsWrapper']/header/div[3]/div/section[1]/ul/li[5]");
    By songAddedMessageLocator = By.cssSelector("div.alertify-logs.top.right");
